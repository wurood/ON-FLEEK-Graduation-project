...
public class home extends Fragment  implements
        ElementsAdapter.Callbacks , ElementsAdapter.OnItemClicked {

    private List<Elements> mainList;
    private List<Elements> dummyList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final CharSequence[] names = getResources().getStringArray(R.array.my_array);
        ...
        for(int i = 0; i<names.length; ++i) {
            ...
            elements.setIcon(images[i]);
            elements.setName(String.valueOf(names[i]));
        ...
        elementsAdapter = new ElementsAdapter(getActivity().getApplicationContext(),dummyList);
        ...
        elementsAdapter.setOnClick(this);
...
//*******************************************************************************************
    ...
    public void onItemClick(int position) {
        startActivity(new Intent(getActivity().getApplicationContext(), test_main.class));
        getActivity(). finish();
